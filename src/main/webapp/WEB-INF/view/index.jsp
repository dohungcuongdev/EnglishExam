							...
							<div class="fix main_content_container">
								...
								<div class="fix single_content_latest_post floatleft">
									<div class="single_page_content">
										<h1>Reading</h1>
										<p class="post_meta fix"><span>Time 1 hour</span>
										<h2>READING PASSAGE 1</h2>
										<h6>You should spend about 20 minutes on Questions 1–13, which are based on Reading 
										Passage 1 below. </h6>
										<center><h2>MAKING TIME FOR SCIENCE </h2></center>
										<p>Chronobiology might sound a little futuristic – like something from a science
...
natural rhythms for extended periods of time. Plants appear no more malleable in this respect; studies demonstrate that vegetables grown in season and ripened on the tree
...
sleep. Consuming a modest snack should be entirely sufficient. 
										...
										<ol>
											<li>A. <input type="radio" name="gender" value="male"> Male<br></li>
											<li>B. <input type="radio" name="gender" value="male"> Male<br></li>
											<li>C. <input type="radio" name="gender" value="male"> Male<br></li>
											<li>D. <input type="radio" name="gender" value="male"> Male<br></li>
										</ol>
						...
						<div class="sidebar floatright">
							...
							<div class="fix single_sidebar">
								<h2><span>Categoris</span></h2>
								<ul>
									<li><a href="">single category</a>(15)</li>
									<li><a href="">single category</a>(15)</li>
									<li><a href="">single category</a>(15)</li>
									<li><a href="">single category</a>(15)</li>
									<li><a href="">single category</a>(15)</li>
