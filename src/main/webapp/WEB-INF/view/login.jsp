...
<style>
body {
    background-image: url("${pageContext.request.contextPath}/resources/images/custom/blur-background09.jpg");
	    ...
	    <div id="id01" class="modal">
	        <form:form class="modal-content animate" method="post" commandName="loginbean" action="${pageContext.request.contextPath}/check-login.html">
	            <div class="imgcontainer">
	                ...
	                <img src="${pageContext.request.contextPath}/resources/images/custom/login_avatar.png" alt="Avatar" class="avatar">
	            </div>
	            <div class="container">
