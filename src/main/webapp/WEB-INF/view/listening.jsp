				...
				<div class="fix single_content_latest_post floatleft">
					<div class="single_page_content">
						...
						<ol>
							...
							<blockquote>Questions 21-24: Write the correct
								letter, A-H, for each answer.</blockquote>
							...
							<table style="width: 100%">
								...
								<tr>
									<td>B</td>
									<td>Careers lecture</td>
								</tr>
								<tr>
									<td>C</td>
									<td>Computer lab visit</td>
								</tr>
								<tr>
									<td>D</td>
									<td>Dance</td>
								...
								<tr>
									<td>F</td>
									<td>Student Union induction</td>
								</tr>
								<tr>
									<td>G</td>
									<td>University tour</td>
								</tr>
								<tr>
									<td>H</td>
									<td>Legal rights lecture>
								</tr>
							</table>


							<blockquote>Questions 25-30: Write ONE WORD OR A
								NUMBER for each answer.</blockquote>
							<img
